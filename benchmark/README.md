...
BEIR leaderboard (first-stage is MiniLM or `rank-bm25`, not Pyserini).
...
Pyserini). There is no Cohere / ColBERT column.

Local copies of the tables (gitignored):
`benchmark/results/usage_nfcorpus_20260918T121829Z.json`,
`benchmark/results/usage_scifact_20260918T123647Z.json`,
`benchmark/results/usage_nfcorpus_bge-small_20260918T130959Z.json`.
