...
`.env` is gitignored. Never commit `TYPESAFE_API_KEY`, `OPENROUTER_API_KEY`, or other credentials. If a key was pushed, rotate it at the provider and report the leak privately as above.
